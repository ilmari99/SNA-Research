...
players = [BlockusNNPlayer(name="Player 0",
                           model_path="/home/ilmari/python/RLFramework/BlokusGreedyNoDiscountModels/model_1.tflite",
...
game = BlockusGame(board_size=(20,20), logger_args={"log_file" : "blockusgame.log",
                     ...
                     model_paths=["/home/ilmari/python/RLFramework/BlokusGreedyNoDiscountModels/model_1.tflite"],#,"/home/ilmari/python/RLFramework/BlockusModelsMahti/model_15.tflite"],
                  render_mode = "human",
